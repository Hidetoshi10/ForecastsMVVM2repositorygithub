package com.example.forecastsmvvm.data.repository

import androidx.lifecycle.LiveData
import com.example.forecastsmvvm.data.db.CurrentWeatherDao
import com.example.forecastsmvvm.data.db.FutureWeatherDao
import com.example.forecastsmvvm.data.db.WeatherLocationDao
...
import com.example.forecastsmvvm.data.db.unitlocalized.current.UnitSpecificCurrentWeatherEntry
import com.example.forecastsmvvm.data.db.unitlocalized.future.detail.UnitSpecificDetailFutureWeatherEntry
import com.example.forecastsmvvm.data.db.unitlocalized.future.list.UnitSpecificSimpleFutureWeatherEntry
import com.example.forecastsmvvm.data.network.FORECAST_DAYS_COUNT
import com.example.forecastsmvvm.data.network.WeatherNetworkDataSource
